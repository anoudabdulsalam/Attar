...
class CardCustomerScreen extends StatefulWidget {
  ...
  const CardCustomerScreen({super.key, required this.totalPrice});

  @override
  State<CardCustomerScreen> createState() => _CardCustomerScreenState();
}

class _CardCustomerScreenState extends State<CardCustomerScreen> {
