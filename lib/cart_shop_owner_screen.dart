...
import 'card_shop_owner_screen.dart';

class CartShopOwnerScreen extends StatelessWidget {
  final List<Map<String, dynamic>> cartItems;
  final Function(String) onRemove;
  final Function(String, int) onUpdateQuantity;
  final double totalPrice;

  const CartShopOwnerScreen({
    super.key,
        ...
        children: [
          ...
          Container(
            ...
            child: Image.asset(
              ...
              fit: BoxFit.contain,
              errorBuilder: (_, _, _) =>
                  const Icon(Icons.eco, color: Color(0xFF8EB69B), size: 40),
            ),
          ),
          ...
          ElevatedButton(
            onPressed: () {
              Navigator.push(
                ...
                MaterialPageRoute(
                  builder: (context) =>
                      CardShopOwnerScreen(totalPrice: totalPrice),
                ),
              );
            },
