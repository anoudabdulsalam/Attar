...
class StoreNamesShopOwnerScreen extends StatefulWidget {
  const StoreNamesShopOwnerScreen({super.key});

  @override
  State<StoreNamesShopOwnerScreen> createState() =>
      _StoreNamesShopOwnerScreenState();
}

class _StoreNamesShopOwnerScreenState extends State<StoreNamesShopOwnerScreen> {
