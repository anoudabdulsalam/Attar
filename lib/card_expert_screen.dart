...
class CardExpertScreen extends StatefulWidget {
  ...
  const CardExpertScreen({super.key, required this.totalPrice});

  @override
  State<CardExpertScreen> createState() => _CardExpertScreenState();
}

class _CardExpertScreenState extends State<CardExpertScreen> {
