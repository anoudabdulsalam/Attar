...
import 'contact_us_expert_screen.dart';
import 'profile_expert_screen.dart';
import 'favorites_expert_screen.dart';
...
class _HomeExpertScreenState extends State<HomeExpertScreen> {
      ...
      builder: (BuildContext ctx) {
        ...
        return StatefulBuilder(
          builder: (context, setDialogState) {
            final filtered =
                experts.where((e) => e.contains(searchQuery)).toList();
            return AlertDialog(
                        ...
                        itemBuilder: (context, index) {
                          return ListTile(
                            ...
                            trailing: IconButton(
                              ...
                              onPressed: () {
                                Navigator.pop(ctx);
                                final expertName = filtered[index];
                                final chatName = expertName.contains('-')
                                    ? expertName.split('-')[0].trim()
                                    : expertName;
                                ChatDetailExpertScreen.addSharedPost(
                                  chatName,
                                  plant,
                                );
  ...
  Widget _buildCurrentBody() {
    switch (_selectedIndex) {
      case 0:
        return const StoreNamesExpertScreen();
      case 1:
        return const ChatExpertScreen();
      case 2:
        return _buildHomeContent();
      case 3:
        return const NotificationsExpertScreen();
      case 4:
        return CartExpertScreen(
      ...
      case 7:
        return const ProfileExpertScreen();
      case 8:
        return const ContactUsExpertScreen();
      default:
        return _buildHomeContent();
    }
  }
